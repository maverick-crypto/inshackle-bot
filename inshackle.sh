C #!/bin/bash
# Inshackle v1.0
# recoded by: Jaykishan Rawat
# https://github.com/maverick-crypto/inshackle-bot
...
printf "      \e[1;31m[\e[0m\e[1;77mv1.0\e[0m\e[1;31m]\e[0m\e[1;77m recoded by Jaykishan Rawat \e[0m\n"
}
